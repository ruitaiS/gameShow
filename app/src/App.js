...
function intersectsAt(p1,p2, p3, p4 ){
    ...
    let xMax = Math.max(p1[0], p2[0], p3[0], p4[0]);
    let xMin = Math.min(p1[0], p2[0], p3[0], p4[0]);
    let yMax = Math.max(p1[1], p2[1], p3[1], p4[1]);
    let yMin = Math.min(p1[1], p2[1], p3[1], p4[1]);
    alert(xMax);

    let m1 = (p1[1] - p2[1]) / (p1[0] - p2[0]);
    let m2 = (p3[1] - p3[1]) / (p4[0] - p4[0]);
    alert(m1);
...
function drawSegment(p1,p2){
    ...
    //Testing Intersects
    /*    
    if (intersectsAt([500,0],[501,1000],[joints[2*p1]*1000, joints[2*p1+1]*1000],[ joints[2*p2]*1000, joints[2*p2+1]*1000])){
        alert("intersects!");
    };*/
...
function DrawFigure(){
    ...
    if (intersectsAt([500,0],[501,1000],[0,500],[1000,501])){
        alert("intersects!");
    };
